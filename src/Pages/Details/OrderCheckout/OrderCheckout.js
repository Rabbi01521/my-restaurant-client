    ...
    <div>
      ...
      {loading ? (
        ...
        <Container className="mb-5">
          <div>
            <h2 className="text-center fw-bold text-success py-4">
              Order Checkout
            </h2>
          </div>
          ...
          <Row xs={1} sm={1} md={1} lg={2} xl={2}>
            <Col>
              <div className="bg-light py-5 rounded-3 border">
                <p className="fs-4 fw-bold text-center text-info">
                  Product Information
                </p>
                ...
                <div className="mx-3">
                  <div className="text-center">
                    <img
                      ...
                      alt=""
                      className={`${"mx-auto w-50 border rounded-3"} ${
                        styles.imgSide
                      }`}
                    />
                  </div>
            ...
            <Col>
              <div
                className="bg-light py-5 rounded-3 border"
